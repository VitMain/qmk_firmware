const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.rm65xhCe.js","assets/chunks/framework.DUYk0S7v.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.rm65xhCe.js"), true ? __vite__mapDeps([0,1]) : void 0));
